...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnFirstTwoHiredEmployees()
    {
        ...
        var firstTwo = emps
        .OrderBy(e => e.HireDate).Take(2).ToList();; 
    ...
    public void AllEmployeesShouldEarnMoreThan500()
    {
        ...
        var result = (from e in emps where e.Sal > 500 select e).All(e => e.Sal > 500);
    ...
    public void ShouldFindAnyWithCommissionOver400()
    {
        ...
        var result = (from e in emps where e.Comm > 400 select e).Any();
    ...
    public void ShouldReturnEmployeeManagerPairs()
    {
        ...
        var result = (from e1 in emps join e2 in emps on e1.Mgr equals e2.EmpNo select new { Employee = e1.EName, Manager = e2.EName }).ToList();
    ...
    public void ShouldReturnTotalIncomeIncludingCommission()
    {
        ...
        var result = (from e in emps let totalIncome = e.Sal + (e.Comm ?? 0) select new { e.EName, Total = totalIncome }).ToList(); 
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = (from e in emps join d in depts on e.DeptNo equals d.DeptNo join s in grades on 1 equals 1 where e.Sal >= s.Losal && e.Sal <= s.Hisal select new { e.EName, d.DName, s.Grade }).ToList(); 
