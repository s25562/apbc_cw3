...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        var chicagoDeptNos = from d in depts where d.Loc == "CHICAGO" select d.DeptNo;
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = (from e in emps join s in grades on 1 equals 1 where e.Sal >= s.Losal && e.Sal <= s.Hisal select new { e.EName, s.Grade }).ToList();
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var result = (from e in emps where e.Sal > (from e2 in emps where e2.DeptNo == e.DeptNo select e2.Sal).Average() select e.EName).ToList();
